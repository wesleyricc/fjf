...
class _EditPlayerScreenContentState extends State<_EditPlayerScreenContent> {
  ...
  Future<void> _handleSave(EditPlayerViewModel vm) async {
    ...
    final result = await vm.savePlayer(
      ...
      portalAuthService: Provider.of<PortalAuthService>(context, listen: false),
    );
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SwitchListTile(
                        title: const Text('Gerar Acesso ao Portal do Atleta?', style: TextStyle(fontWeight: FontWeight.bold)),
                        subtitle: const Text('Cria um login para o atleta acessar o aplicativo.'),
                        value: vm.createPortalAccess,
                        onChanged: vm.setCreatePortalAccess,
                        contentPadding: EdgeInsets.zero,
                      ),
                      if (vm.createPortalAccess)
                        TextFormField(
                          decoration: const InputDecoration(
                            labelText: 'Senha de Acesso',
                            border: OutlineInputBorder(),
                            helperText: 'O usuário será gerado como: nome.sobrenome'
                          ),
                          onChanged: vm.setPortalPassword,
                        ),
                    ],
                  ),
                ),

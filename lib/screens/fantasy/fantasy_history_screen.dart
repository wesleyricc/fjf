  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FantasyService().streamHistory(userId),
        builder: (context, snapshot) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text("Participe das rodadas para ver sua evolução.",
          ...
          return ListView.builder(
            ...
            itemBuilder: (ctx, i) {
              ...
              if (points >= 60)
                scoreColor = Colors.green[700]!; // Excelente
              else if (points >= 40)
                scoreColor = Colors.blue[700]!; // Bom
              else if (points >= 20)
                scoreColor = Colors.orange[700]!; // Regular
              else
                scoreColor = Colors.red[700]!; // Ruim
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text("Pontos",
                              style:
                                  TextStyle(fontSize: 12, color: scoreColor)),
                          Text(

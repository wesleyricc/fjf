  ...
  Widget _buildScoutCard() {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            _buildScoreRow("Gol", "+ 8.0 pts", Colors.green),
            const Divider(),
            _buildScoreRow("Assistência", "+ 5.0 pts", Colors.blue),
            const Divider(),
            _buildScoreRow("Jogo sem sofrer gol (SG)", "+ 5.0 pts", Colors.teal),
            const Divider(),
            _buildScoreRow("Pênalti Defendido (PD)", "+ 5.0 pts", Colors.orange),
            const Divider(),
            _buildScoreRow("Finalização na Trave (FT)", "+ 3.0 pts", Colors.brown),
            const Divider(),
            _buildScoreRow("Cartão Amarelo", "- 1.0 pts", Colors.amber[800]!),
            const Divider(),
            _buildScoreRow("Pênalti Perdido (PP)", "- 3.0 pts", Colors.deepPurple),
            const Divider(),

...
class PhotoStoreBanner extends StatefulWidget {
  const PhotoStoreBanner({super.key});

  @override
  State<PhotoStoreBanner> createState() => _PhotoStoreBannerState();
}

class _PhotoStoreBannerState extends State<PhotoStoreBanner> {
  @override
  void initState() {
    super.initState();
    // 🚨 LAZY LOADING: Carrega a foto da loja assim que o card renderizar
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<PhotoBannerViewModel>(context, listen: false).loadLatestPhoto();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<PhotoBannerViewModel>(
      builder: (context, photoVm, _) {
        final photo = photoVm.latestPhotoProduct;
